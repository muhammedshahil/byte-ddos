...
# To run the script successfully, you can make this change throughout the script where print statements are used. Here's an updated version of the script with the necessary changes
